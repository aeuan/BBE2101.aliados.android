...
public class RecyclerAdapterPromotionsSingleAdapter extends RecyclerView.Adapter<RecyclerAdapterPromotionsSingleAdapter.ViewHolder> {
    private Context context;
    private List<PromotionDataEntity> items;
    private Activity activity;

    public RecyclerAdapterPromotionsSingleAdapter(Activity activity, Context context, List<PromotionDataEntity> items) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
                Intent intent = new Intent(context, PromotionsDetailActivity.class);
                intent.putExtra("beneficio", items.get(getAdapterPosition()));
